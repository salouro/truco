...
public class PainelMenu extends JPanel{
	...
	private ImageIcon novoIcon = new ImageIcon(this.getClass().getResource("/img/cenario/novo1.jpg"));
	private ImageIcon novoHoverIcon = new ImageIcon(this.getClass().getResource("/img/cenario/novo.jpg"));
	private ImageIcon placarIcon = new ImageIcon(this.getClass().getResource("/img/cenario/placar1.jpg"));
	private ImageIcon placarHoverIcon = new ImageIcon(this.getClass().getResource("/img/cenario/placar.jpg"));
